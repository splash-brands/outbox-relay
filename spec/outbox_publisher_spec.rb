  ...
  describe ".publish" do
    ...
    context "with invalid parameters" do
      it "raises error when topic is blank" do
        ...
        }.to raise_error(ArgumentError, /topic must be present/)
      end
      ...
      it "raises error when payload is not Hash or Array" do
        ...
        }.to raise_error(ArgumentError, /payload must be a Hash or Array/)
      end
      ...
      it "raises PublishError when event creation fails" do
        ...
        }.to raise_error(OutboxRelay::OutboxPublisher::PublishError, /Failed to publish event/)
      end
    end
